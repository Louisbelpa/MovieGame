    ...
    <tr className="hover:bg-gray-50 transition-colors group">
      ...
      <td className="sticky right-0 bg-white group-hover:bg-gray-50 transition-colors px-3 py-3 text-right border-l border-gray-100 shadow-[-4px_0_6px_-2px_rgba(0,0,0,0.04)]">
        <div className="flex items-center justify-end gap-1">
          ...
          <button onClick={() => onBackdrops(series)} title="Backdrops TMDB" className="p-2 sm:p-1.5 bg-amber-50 text-amber-600 sm:bg-transparent sm:text-gray-400 hover:text-amber-600 hover:bg-amber-50 rounded-lg transition-colors">
            <Images size={14} />
          </button>
          <button onClick={() => onEdit(series)} title="Modifier" className="p-2 sm:p-1.5 bg-indigo-50 text-indigo-600 sm:bg-transparent sm:text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors">
            <Pencil size={14} />
          </button>
          <button onClick={() => onDelete(series)} title="Supprimer" className="p-2 sm:p-1.5 bg-red-50 text-red-600 sm:bg-transparent sm:text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors">
            <Trash2 size={14} />
          </button>
        </div>
      </td>
