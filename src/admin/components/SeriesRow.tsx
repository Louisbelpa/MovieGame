        ...
        <td className="px-3 py-3" colSpan={10}>
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="font-medium text-sm text-gray-900 truncate">{series.title}</div>
              {series.year && <div className="text-xs text-gray-500 mt-0.5">{series.year}</div>}
        ...
        <td className="px-3 py-3 hidden lg:table-cell">
          <div className="flex flex-col gap-1">
            <span className={['inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium',
              series.is_active ? 'bg-emerald-100 text-emerald-700' : 'bg-gray-100 text-gray-500'].join(' ')}>
