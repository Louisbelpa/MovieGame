  ...
  return (
    <div className="flex flex-col gap-1">
      <button
        ...
        style={{ border: '1px solid #dadce0', color: '#3c4043', fontSize: '14px' }}
        className="w-full flex items-center justify-center gap-2 rounded-lg bg-white px-4 py-2.5 font-medium hover:bg-gray-50 transition-colors cursor-pointer"
      >
        {/* Google G logo */}
